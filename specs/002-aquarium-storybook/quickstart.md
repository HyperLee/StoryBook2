...
4. 在 `/aquarium` 搜尋「海馬」與 `reef`，1 秒內看到符合結果或無結果提示。
...
8. 使用上一頁/下一頁連續瀏覽至少 3 筆，再用瀏覽器上一頁/下一頁確認 history 正確。
...
14. 在 1366x768 與 768px 寬度檢查主要內容不需水平捲動，且搜尋、語言切換、上一頁、下一頁與回首頁控制項維持可見且容易操作。

...
- 搜尋前必須 trim 前後空白、合併多餘空白，並忽略不影響語意的標點。
- 搜尋正規化後若少於 2 個有效搜尋字元或英文字母數字，必須顯示友善提示並保留可探索內容，不得呈現誤導性的搜尋結果。
- 英文搜尋必須忽略大小寫差異。
...
- 每頁一次只聚焦一隻水族館生物。
- 必須顯示名稱、生活區域分類、生活環境、食性、發現地點、簡短介紹、小故事、主要圖片與故事插圖。
...
- 資料載入失敗狀態必須提供重新嘗試與回首頁動作，且不得顯示空白內容頁。
